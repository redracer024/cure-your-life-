...
export const AppFooter: React.FC = () => {
    return (
        <footer className="border-t border-white/10 bg-black/60 py-3 md:py-6 px-6 md:px-10 text-[11px] text-slate-500 font-mono">
            ...
            <div className="max-w-7xl mx-auto mt-3 pt-3 md:mt-4 md:pt-4 border-t border-white/5 flex flex-wrap gap-x-5 gap-y-2 items-center">
